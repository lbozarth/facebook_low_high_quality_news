...
class BaseLabelPropagation:
    """
    This code is originally from stackoverflow https://stackoverflow.com/search?q=label+spreading&s=e45dcbfb-b096-44d2-adf7-fecee83b791d
    ...
    def _one_hot_encode(self, labels):
        ...
        # print(self.one_hot_labels.shape)
        # print('unsqueeze', labels.unsqueeze(1).shape)
...
class LabelPropagationer(BaseLabelPropagation):
    def __init__(self, adj_matrix):
...
class LabelSpreadinger(BaseLabelPropagation):
    def __init__(self, adj_matrix):
        super().__init__(adj_matrix)
        self.alpha = None
